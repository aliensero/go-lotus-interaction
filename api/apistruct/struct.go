...
import (
	...
	"github.com/aliensero/go-lotus-interaction/modules/dtypes"
...
type WorkerStruct struct {
	Internal struct {
		...
		Version func(context.Context) (types.Version, error) `perm:"admin"`
...
func (w *WorkerStruct) Version(ctx context.Context) (types.Version, error) {
